                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="findall?page=1&pagesize=${productlist.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="findall?page=${productlist.pageNum-1}&pagesize=${orderlist.pageSize}">上一页</a></li>
                                <c:forEach begin="1" end="${productlist.pages}" var="pagenum">
                                    <li><a href="findall?page=${pagenum}&pagesize=${productlist.pageSize}">${pagenum}</a></li>

                                </c:forEach>
                                <li><a href="findall?page=${productlist.pageNum+1}&pagesize=${productlist.pageSize}">下一页</a></li>
                                <li>
                                    <a href="findall?page=${productlist.pages}&pagesize=${productlist.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
                    <!-- /.box-footer-->
