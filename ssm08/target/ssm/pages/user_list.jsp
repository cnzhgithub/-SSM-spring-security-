                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">用户邮箱</th>
                            ...
                            <c:forEach items="${user}" var="eachuser">
                                <tr>
                                    ...
                                    <td>${eachuser.uphonenum}</td>
                                    <td>${eachuser.ustatus}</td>
                                    <td class="text-center">

                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/findbyid?id=${eachuser.id}'">详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/byIdaddRole?id=${eachuser.id}'">添加角色</button>
                                    </td>
                                </tr>
                            </c:forEach>
