    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">可以添加的权限</a></li>
                <li class="active">权限信息填写</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
        <%--正文--%>
        ...
        <section class="content">
            <form method="post" action="/role/insertper">
                <input type="hidden" name="rid" value="${onerole.rid}">
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${listper}" var="eachper">
                        <tr>
                            <td><input name="pids" type="checkbox" value="${eachper.pid}"></td>
                            <td>${eachper.pid}</td>
                            <td>${eachper.pname}</td>
                            <td>${eachper.url}</td>
                        </tr>
