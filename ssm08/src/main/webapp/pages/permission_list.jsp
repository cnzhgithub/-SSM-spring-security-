                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${permissionlist}" var="eachpermission">
                                <tr>
                                    <td><input name="ids" type="checkbox"></td>
                                    <td>${eachpermission.pid}</td>
                                    <td>${eachpermission.pname}</td>
                                    <td>${eachpermission.url}</td>
                                    <td>
                                    <button type="button" class="btn bg-olive btn-xs" onclick="chageadd()">添加资源</button>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    function chageadd() {
        location.href="${pageContext.request.contextPath}/pages/permission_add.jsp"
    }
